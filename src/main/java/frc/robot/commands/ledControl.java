...
public class ledControl {
    ...
    public void setDemo(int demoNumber) {
        ...
        switch (demoNumber) {
            ...
            default:
                System.err.println("Err(setDemo(int)): Demo not found. Check the function description to see what demos are available. If thats unavailable AFAIK the currently available demos are 0 and 1");
                break;
        }
    ...
    /**
     * Tells the controller to start up a demo based on the demoNumber
     * @param demoNumber (String) which demo to display
     * Current Available Demos(Case unimportant):
     * (Rainbow): Rainbow
     * (Firebird): Firebird
     */
    public void setDemo(String demo) {
        ...
        switch (demo.toLowerCase()) {
            ...
            default:
                System.err.println("Err(setDemo(String)): demo not found. Check the function description to see what demos are available.");
                break;
        }
        ...
        if (success == true) {
            ...
            System.err.println("Err(setDemo(String)): SendData Failed. Check SendData error message.");
            return;
        }
     ...
     * (1): Flashes yellow for a second to indicate we're lined up to shoot into the speaker.
     * (2): Flashes red for a second to indicate we're lined up to shoot into the amp.
     */
    public void setGameEvent(int gameEvent) {
        ...
        switch (gameEvent) {
            ...
            default:
                System.err.println("Err(setGameEvent(int)): gameEvent not found. Check the function description to see what demos are available.");
                break;
        }
        ...
        if (success == true) {
            ...
            System.err.println("Err(setGameEvent(int)): SendData Failed. Check SendData error message.");
            return;
        }
    ...
    /**
     * A tentative implementation of a "Game Event" System. 
     * @param gameEvent (String) Which "Game Event" has happened. Current "Events":
     * (note): Flashes green for a second to indicate a note has been picked up.
     * (speaker): Flashes yellow for a second to indicate we're lined up to shoot into the speaker.
     * (amp): Flashes red for a second to indicate we're lined up to shoot into the amp.
     */
    public void setGameEvent(String s_gameEvent) {

        m_byte1 = 0x03; //Parse byte indicating "Game Event Mode"

        switch (s_gameEvent.toLowerCase()) {
            ...
            default:
                System.err.println("Err(setGameEvent(String)): s_gameEvent not found. Check the function description to see what demos are available.");
                break;
        }
        ...
        if (success == true) {
            ...
            System.err.println("Err(setGameEvent(String)): SendData Failed. Check SendData error message.");
            return;
        }
    ...
    public void reset() {
        ...
        if (success == true) {
            ...
            System.err.println("Err(reset): SendData Failed. Check SendData error message.");
            return;
        }
    }
