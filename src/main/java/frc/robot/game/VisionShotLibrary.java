...
public class VisionShotLibrary {
     ...
     * @return the existing Vision shot library, to make declarative definition in
    ...
    public static Shot getShotForDistance(double distance) {
        return new Shot("Generated Vision Shot", mLaunchAngleDoubleTreeMap.get(distance),
                mFlywheelSpeedDoubleTreeMap.get(distance));
    }
